      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-3 xl:gap-4">
            ...
            <div className="flex items-center bg-slate-100 border border-slate-200 rounded-full p-0.5 mr-1">
              <button
                onClick={() => handleCurrencyChange('INR')}
                className={`px-2 py-0.5 rounded-full text-[9px] xl:text-[10px] font-bold transition-colors ${
            ...
            <Link
              href="/quote"
              className="relative inline-flex items-center gap-1.5 px-3 py-1.5 xl:px-4 xl:py-2 text-[10px] xl:text-xs font-semibold uppercase tracking-wider text-slate-700 glass-card hover:glass-card-hover rounded-full transition-all duration-300 overflow-hidden group whitespace-nowrap"
            >
            ...
            <Link
              href="/booking"
              className="inline-flex items-center gap-1 px-3 py-1.5 xl:px-4 xl:py-2 text-[10px] xl:text-xs font-semibold uppercase tracking-wider text-white bg-slate-900 rounded-full hover:bg-slate-800 transition-colors whitespace-nowrap"
            >
              Consult Now
