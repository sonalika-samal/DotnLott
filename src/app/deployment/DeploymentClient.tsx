    ...
    <div className="relative min-h-screen overflow-hidden bg-[#f8fafc] py-16 px-4 sm:px-6 lg:px-8 z-10 font-sans">
      ...
      <div className="max-w-6xl mx-auto flex flex-col gap-16">
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-6 md:p-8 shadow-sm flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            <h2 className="text-xl md:text-2xl font-bold text-slate-900">Side-by-Side Model Comparison</h2>
            <p className="text-xs text-slate-500 font-light">Detailed technical comparison of features to help you select the right hosting architecture.</p>
          </div>
            ...
            <table className="w-full text-left border-collapse text-xs">
              <thead>
                <tr className="border-b border-slate-200 text-slate-500 font-semibold uppercase tracking-wider text-[10px]">
                  ...
                  <th className="py-3 px-4 text-brand-blue">Managed Cloud hosting</th>
                  <th className="py-3 px-4 text-brand-purple">Dedicated VPS Deployment</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100 font-light text-slate-750">
                <tr>
                  <td className="py-3.5 px-4 font-semibold text-slate-900">Server Ownership</td>
                  <td className="py-3.5 px-4">DotnLott Shared Cloud Infrastructure</td>
                  <td className="py-3.5 px-4">Client-Owned (AWS, GCP, Hetzner, etc.)</td>
                </tr>
                <tr>
                  <td className="py-3.5 px-4 font-semibold text-slate-900">Setup Time</td>
                  <td className="py-3.5 px-4 text-emerald-600 font-medium">3 - 7 Business Days</td>
                  <td className="py-3.5 px-4">2 - 4 Weeks (Depending on complexity)</td>
                </tr>
                <tr>
                  <td className="py-3.5 px-4 font-semibold text-slate-900">Financial Investment</td>
                  <td className="py-3.5 px-4">Low monthly hosting fee</td>
                  <td className="py-3.5 px-4">Custom setup cost + Client server fees</td>
                </tr>
                <tr>
                  <td className="py-3.5 px-4 font-semibold text-slate-900">Database Ownership</td>
                  <td className="py-3.5 px-4">Securely isolated & encrypted database</td>
                  <td className="py-3.5 px-4 text-emerald-600 font-medium">100% Dedicated Private Database</td>
                </tr>
                <tr>
                  <td className="py-3.5 px-4 font-semibold text-slate-900">Security & Compliance</td>
                  <td className="py-3.5 px-4">Standard SSL & supabase encryption</td>
                  <td className="py-3.5 px-4 text-emerald-600 font-medium">SOC2/HIPAA Readiness & isolated networks</td>
                </tr>
                <tr>
                  <td className="py-3.5 px-4 font-semibold text-slate-900">Maintenance & Updates</td>
                  <td className="py-3.5 px-4">Included automatically at no cost</td>
                  <td className="py-3.5 px-4">30 days complimentary, then SLA/AMC option</td>
                </tr>
                <tr>
                  <td className="py-3.5 px-4 font-semibold text-slate-900">Migratability</td>
                  <td className="py-3.5 px-4 text-emerald-600 font-medium">Seamless: Upgrade to Dedicated at any time</td>
                  <td className="py-3.5 px-4">Fully portable code base at all times</td>
                </tr>
              </tbody>
            </table>
          </div>
